      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Car rental service with smiling prices.</h1>
            <p>Spend less and hire the best </p>
            <a href="#resentnewcar" class="btn">View Car </a> </div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#" id="resentnewcar" role="tab" data-toggle="tab">New Car</a></li>
        </ul>
      </div>
    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-calendar" aria-hidden="true"></i>35+</h2>
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-car" aria-hidden="true"></i>800+</h2>
            <p>High Facility Cars </p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>1600+</h2>
            <p>Happy Customers</p>
          </div>
        </div>
      </div>
